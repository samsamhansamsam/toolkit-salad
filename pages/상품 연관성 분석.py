...
def run_product_analysis():
    ...
    if uploaded_file is not None:
        ...
        product_display_names = {
            row['상품_식별자']: f"{row['상품_식별자']} - {row['상품명']} ({row['상품 옵션']})" if row['상품 옵션'] else f"{row['상품 코드']} - {row['상품명']}"
        ...
        if selected_product_identifier:
            ...
            if related_products:
                ...
                df_display = df_related[['상품_식별자', '상품명', '상품 옵션', '함께 구매된 횟수']].head(10)
        ...
        if selected_product_identifier:
            ...
            if related_upsell_products:
                ...
                df_display_upsell = df_related_upsell[['상품_식별자', '상품명', '상품 옵션', '함께 구매된 횟수']].head(10)
